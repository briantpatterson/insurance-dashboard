    ...
    <DashboardLayout>
      <div className="flex flex-col space-y-8">
        ...
        <div className="mt-6 hidden">
          <h2 className="text-xl font-semibold mb-4">Active Benefits</h2>
          <div className="grid gap-4 md:grid-cols-2">
            {/* Dental Benefit Card */}
            <Card>
              <CardHeader className="pb-2">
                ...
                <CardDescription>Coverage for routine and emergency dental care</CardDescription>
              </CardHeader>
              <CardContent className="pb-2">
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Plan</span>
                    <span className="font-medium">Premium PPO</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Provider</span>
                    <span className="font-medium">Delta Dental</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Enrolled</span>
                    <span className="font-medium">342 employees (86%)</span>
                  </div>
                </div>
              </CardContent>
              <CardFooter>
            ...
            <Card>
              <CardHeader className="pb-2">
                ...
                <CardDescription>Coverage for eye exams, glasses, and contacts</CardDescription>
              </CardHeader>
              <CardContent className="pb-2">
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Plan</span>
                    <span className="font-medium">Enhanced Vision</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Provider</span>
                    <span className="font-medium">VSP</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Enrolled</span>
                    <span className="font-medium">278 employees (81%)</span>
                  </div>
                </div>
              </CardContent>
              <CardFooter>
                <Button variant="ghost" className="w-full" asChild>
                  <Link href="/benefits/vision">
                    View Details
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
            ...
            <Card>
              <CardHeader className="pb-2">
                ...
                <CardDescription>Income protection for short-term illnesses and injuries</CardDescription>
              </CardHeader>
              <CardContent className="pb-2">
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Plan</span>
                    <span className="font-medium">Comprehensive STD</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Provider</span>
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Enrolled</span>
                    <span className="font-medium">312 employees (91%)</span>
                  </div>
                </div>
              </CardContent>
              <CardFooter>
                <Button variant="ghost" className="w-full" asChild>
                  <Link href="/benefits/std">
                    View Details
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
            ...
            <Card>
              <CardHeader className="pb-2">
                ...
                <CardDescription>Income protection for extended illnesses and disabilities</CardDescription>
              </CardHeader>
              <CardContent className="pb-2">
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Plan</span>
                    <span className="font-medium">Extended LTD Plus</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Provider</span>
                    <span className="font-medium">MetLife</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Enrolled</span>
                    <span className="font-medium">298 employees (87%)</span>
                  </div>
                </div>
              </CardContent>
              <CardFooter>
                <Button variant="ghost" className="w-full" asChild>
                  <Link href="/benefits/ltd">
                    View Details
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
